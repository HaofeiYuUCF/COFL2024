...
Partial Class Results
    ...
    Private Sub InitializeComponent()
        ...
        TextBox1031 = New TextBox()
        TextBox1041 = New TextBox()
        TextBox1051 = New TextBox()
        TextBox1061 = New TextBox()
        TextBox1071 = New TextBox()
        ...
        Label3.Location = New Point(248, 101)
        Label3.Name = "Label3"
        ...
        Label4.Location = New Point(85, 151)
        Label4.Name = "Label4"
        ...
        Button1.Location = New Point(85, 909)
        ...
        Label39.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        Label39.Location = New Point(280, 522)
        Label39.Name = "Label39"
        Label39.Size = New Size(204, 32)
        Label39.TabIndex = 42
        Label39.Text = "Environmental Data"
        ' 
        ' Label13
        ' 
        ...
        Label13.Location = New Point(992, 101)
        Label13.Name = "Label13"
        Label13.Size = New Size(270, 32)
        Label13.TabIndex = 43
        Label13.Text = "               Result                  "
        ' 
        ' Label5
        ...
        Label5.TabIndex = 44
        Label5.Text = "Facility Name"
        ' 
        ' Label6
        ' 
        Label6.AutoSize = True
        Label6.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label6.Location = New Point(85, 309)
        Label6.Name = "Label6"
        ...
        Label12.Location = New Point(85, 240)
        Label12.Name = "Label12"
        Label12.Size = New Size(78, 20)
        Label12.TabIndex = 50
        Label12.Text = "Run Name"
        ' 
        ' Label21
        ' 
        Label21.AutoSize = True
        Label21.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label21.Location = New Point(85, 209)
        Label21.Name = "Label21"
        Label21.Size = New Size(91, 20)
        Label21.TabIndex = 49
        Label21.Text = "User's Name"
        ' 
        ' Label47
        ' 
        Label47.AutoSize = True
        Label47.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label47.Location = New Point(85, 675)
        Label47.Name = "Label47"
        Label47.Size = New Size(100, 20)
        Label47.TabIndex = 68
        Label47.Text = "Stability Class" & vbCrLf
        ' 
        ' Label48
        ' 
        Label48.AutoSize = True
        Label48.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label48.Location = New Point(85, 644)
        Label48.Name = "Label48"
        Label48.Size = New Size(69, 20)
        Label48.TabIndex = 67
        Label48.Text = "Land Use" & vbCrLf
        ' 
        ' Label49
        ' 
        Label49.AutoSize = True
        Label49.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label49.Location = New Point(85, 777)
        Label49.Name = "Label49"
        Label49.Size = New Size(123, 20)
        Label49.TabIndex = 66
        Label49.Text = "8 Hr. Background"
        ' 
        ' Label50
        ' 
        Label50.AutoSize = True
        Label50.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label50.Location = New Point(85, 744)
        Label50.Name = "Label50"
        Label50.Size = New Size(123, 20)
        Label50.TabIndex = 65
        Label50.Text = "1 Hr. Background"
        ' 
        ' Label51
        ' 
        Label51.AutoSize = True
        Label51.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label51.Location = New Point(85, 710)
        Label51.Name = "Label51"
        Label51.Size = New Size(133, 20)
        Label51.TabIndex = 64
        Label51.Text = "Surface Roughness"
        ' 
        ' Label52
        ' 
        Label52.AutoSize = True
        Label52.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label52.Location = New Point(85, 615)
        Label52.Name = "Label52"
        Label52.Size = New Size(140, 20)
        Label52.TabIndex = 63
        Label52.Text = "Reid Vapor Pressure"
        ' 
        ' Label53
        ' 
        Label53.AutoSize = True
        Label53.Font = New Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        Label53.Location = New Point(85, 586)
        Label53.Name = "Label53"
        Label53.Size = New Size(93, 20)
        Label53.TabIndex = 62
        ...
        Button3.Location = New Point(1038, 908)
        ...
        ' TextBox171
        ' 
        TextBox171.Font = New Font("Segoe UI Semibold", 18F, FontStyle.Bold, GraphicsUnit.Point)
        TextBox171.Location = New Point(384, 806)
        TextBox171.Multiline = True
        TextBox171.Name = "TextBox171"
        TextBox171.Size = New Size(687, 72)
        TextBox171.TabIndex = 193
        TextBox171.Text = "*******************************************************" & vbCrLf & "*********PROJECT FAILS SCREENING MODEL********" & vbCrLf
        ...
        Controls.Add(TextBox124)
        Controls.Add(TextBox125)
        Controls.Add(TextBox1071)
        Controls.Add(TextBox1061)
        Controls.Add(TextBox1051)
        Controls.Add(TextBox1041)
        Controls.Add(TextBox1031)
        Controls.Add(TextBox102)
        Controls.Add(TextBox101)
        Controls.Add(TextBox100)
        Controls.Add(TextBox99)
        Controls.Add(TextBox98)
        Controls.Add(TextBox97)
        Controls.Add(TextBox96)
        Controls.Add(TextBox95)
        Controls.Add(TextBox94)
        Controls.Add(TextBox93)
        Controls.Add(TextBox92)
        Controls.Add(TextBox91)
        Controls.Add(TextBox103)
        Controls.Add(TextBox104)
        Controls.Add(TextBox105)
        Controls.Add(TextBox106)
        Controls.Add(TextBox107)
        Controls.Add(TextBox108)
        Controls.Add(TextBox109)
        Controls.Add(TextBox110)
        Controls.Add(TextBox111)
        Controls.Add(TextBox112)
        Controls.Add(TextBox133)
        Controls.Add(TextBox134)
        Controls.Add(TextBox135)
        Controls.Add(TextBox136)
        Controls.Add(TextBox137)
        Controls.Add(TextBox138)
        Controls.Add(TextBox139)
        Controls.Add(TextBox140)
        Controls.Add(TextBox141)
        Controls.Add(TextBox142)
        Controls.Add(TextBox113)
        Controls.Add(TextBox114)
        Controls.Add(TextBox115)
        Controls.Add(TextBox116)
        Controls.Add(TextBox117)
        Controls.Add(TextBox118)
        Controls.Add(TextBox119)
        Controls.Add(TextBox120)
        Controls.Add(TextBox121)
        Controls.Add(TextBox122)
        Controls.Add(TextBox143)
        Controls.Add(TextBox144)
        Controls.Add(TextBox145)
        Controls.Add(TextBox146)
        Controls.Add(TextBox147)
        Controls.Add(TextBox148)
        Controls.Add(TextBox149)
        Controls.Add(TextBox150)
        Controls.Add(TextBox151)
        Controls.Add(TextBox152)
        Controls.Add(TextBox7)
        Controls.Add(TextBox5)
        Controls.Add(TextBox3)
        Controls.Add(TextBox1)
        Controls.Add(TextBox173)
    ...
    Friend WithEvents TextBox1031 As TextBox
    Friend WithEvents TextBox1041 As TextBox
    Friend WithEvents TextBox1051 As TextBox
    Friend WithEvents TextBox1061 As TextBox
    Friend WithEvents TextBox1071 As TextBox
